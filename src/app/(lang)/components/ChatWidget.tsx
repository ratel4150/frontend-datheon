...
const panelTransition: Transition = { duration: 0.22, ease: easing }
const msgTransition: Transition   = { duration: 0.2 }
const fabTransition: Transition   = { type: 'spring', stiffness: 300, damping: 20 }
...
export function ChatWidget({ lang }: Props) {
    ...
    initialMessages: [
      {
        id: 'welcome',
        role: 'assistant',
        content: welcomeMsg[lang] ?? welcomeMsg['es'],
      },
    ],
    onFinish: () => {
  ...
  // Fix: HTMLDivElement porque MUI TextField multiline renderiza un div
        ...
        {open && (
          <motion.div
            ...
            style={{
              ...
              backgroundColor: C.bg, width: '370px', height: '520px',
            }}
          >
            {/* Header */}
            <Box sx={{
              px: 2.5, py: 1.75, bgcolor: C.accent, flexShrink: 0,
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.25 }}>
                <Box sx={{ position: 'relative' }}>
                  ...
                  <Box sx={{
                    ...
                    bgcolor: '#22C55E', border: '1.5px solid #fff',
                    animation: 'pulse 2s infinite',
                    '@keyframes pulse': { '0%,100%': { opacity: 1 }, '50%': { opacity: 0.5 } },
                  }}/>
                </Box>
                <Box>
                  <Typography sx={{ fontWeight: 700, fontSize: '0.88rem', color: '#fff', lineHeight: 1.2 }}>
                    {tx('title', lang)}
                  </Typography>
              ...
              <IconButton
                ...
                sx={{ color: '#fff', p: 0.5, borderRadius: '8px', '&:hover': { bgcolor: alpha('#fff', 0.15) } }}
              >
                <FiX size={18}/>
              </IconButton>
            </Box>
            ...
            <Box sx={{
              ...
              {isLoading && (
                ...
                >
                  <Box sx={{
                    px: 1.75, py: 1.1, bgcolor: C.accentBg,
            ...
            <Box
              ...
              sx={{
                px: 1.5, py: 1.25, borderTop: `1px solid ${C.border}`,
              ...
              <TextField
                ...
                sx={{
                  '& .MuiOutlinedInput-root': {
                    borderRadius: '12px', fontSize: '0.83rem', bgcolor: C.accentBg,
